...
void BitcoinGUI::createToolBars()
{
	...
	toolbar->setStyleSheet("QToolButton { color: #ffffff; font-size: 13px; font-weight: 700; font-family: 'Helvetica'; padding: 5px; padding-left: 8px; border: none; }"
		"QToolButton:hover { background-color: #F1A45E; color: #000000; font-size: 13px; font-weight: 700; font-family: 'Helvetica'; border: none; padding-top: 5px; padding-bottom: 5px; }"
		"QToolButton:checked { background-color: #F1A45E; color: #000000; font-size: 13px; font-weight: 700; font-family: 'Helvetica';  border: none; padding-top: 5px; padding-bottom: 5px; }"
