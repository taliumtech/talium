...
private slots:
    ...
    QString BuyTLM(QString OrderType, double Quantity, double Rate);
    QString SellTLM(QString OrderType, double Quantity, double Rate);
