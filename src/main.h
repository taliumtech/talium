...
#define START_MASTERNODE_PAYMENTS_TESTNET 1516237200 
#define START_MASTERNODE_PAYMENTS 1516237200 

static const int64_t DARKSEND_COLLATERAL = (0.01*COIN);
static const int64_t DARKSEND_POOL_MAX = (4999.99*COIN);
static const int64_t STATIC_POS_REWARD = 2 * COIN; //Constant reward of 2 TLM per COIN.
static const int64_t TARGET_SPACING = 80; // 80s
...
static const int64_t MAX_MONEY = 3200000 * COIN; 
