...
const string strMessageMagic = "Talium Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    else if (nHeight < 100   && nHeight > 1) // Instamining Protection
        nSubsidy = 0 * COIN;	
...
// Lucky PoW blocks:
    ...
    if (nHeight == 111) 
        nSubsidy = 500 * COIN;
    else if (nHeight == 1111) 
        nSubsidy = 500 * COIN;
    else if (nHeight == 11111) 
        nSubsidy = 500 * COIN;
    else if (nHeight == 22222) 
        nSubsidy = 500 * COIN;
    else if (nHeight == 33333) 
        nSubsidy = 500 * COIN;
    else if (nHeight == 44444) 
        nSubsidy = 500 * COIN;
    else if (nHeight == 55555) 
        nSubsidy = 500 * COIN;
    else if (nHeight == 66666) 
        nSubsidy = 500 * COIN;
    else if (nHeight == 77777) 
        nSubsidy = 500 * COIN;
    else if (nHeight == 88888) 
        nSubsidy = 500 * COIN;
    else if (nHeight == 99999) 
        nSubsidy = 500 * COIN;
    else if (nHeight == 111111) 
        nSubsidy = 500 * COIN;
    else if (nHeight == 122222) 
        nSubsidy = 500 * COIN;
    else if (nHeight == 133333) 
        nSubsidy = 500 * COIN;
    else if (nHeight == 144444) 
        nSubsidy = 500 * COIN;
    else if (nHeight == 155555) 
        nSubsidy = 500 * COIN;
    else if (nHeight == 166666) 
        nSubsidy = 500 * COIN;
        ...
        nSubsidy = 500 * COIN;
    else if (nHeight == 211111) 
        nSubsidy = 500 * COIN;
    else if (nHeight == 222222) 
        nSubsidy = 500 * COIN;
...
const int YEARLY_BLOCKCOUNT = 394200; // 394200 blocks will executed every year
